	...
	<fieldset>
		...
		<html:form action="vehicleRegister"  styleId="vehicleForm">
			<table>
				<tr>
					<td>Vehicle Type</td>
					<td><html:select styleId="type" name="VehicleForm" property="type">
				...
				<tr>
					<td>Make</td>
					<td>
					<html:select name="VehicleForm" property="make" styleId="make" onchange="javascript: listboxchange(this.options[this.selectedIndex].value);">
				...
				<tr>
					...
					<td>
					<html:select name="VehicleForm" property="model" styleId="model">
				...
				<tr>
					...
					<td><html:select styleId="policyType" name="VehicleForm" property="policyType" size="1">
					...
					</html:select> &nbsp;Premium Amount&nbsp;<html:select name="VehicleForm" property="policyAmount" size="1">
